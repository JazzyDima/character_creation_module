"""Программа для выбора имени и класса персонажа.
Проверяет навыки в тренировке.
"""
from random import randint


def attack(char_name: str, char_class: str) -> str:
    """Описывает наносимый персонажем урон при атаке.
...
def defence(char_name: str, char_class: str) -> str:
    """Описывает защиту персонажа. Зависит от выбранного класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описывает специальное умение персонажа.
    Зависит от выбранного класса.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Проверка атаки, защиты и специального умения."""
    if char_class == 'warrior':
...
def main():
    """Основная функция, запускающая оставльные."""
